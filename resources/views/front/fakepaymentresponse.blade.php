...
<tr>
            ...
            <tr style="text-align:left; font-size:15px;">
                ...
                <td><?php echo "<b>Merchant ID: </b>"; 
                    ...
                    echo "<b>Store ID: </b>";
                    echo $key3->id."<br>"; 
                    echo $key3->storeName."<br>"; 
                    echo $key3->storeAddress."<br>"."<br>"; 
                    echo $key3->storeRepresentative1."<br>"; 
                    echo $key3->representativeNum1."<br>"; 
                    echo $key3->representativeEmail1."<br>"; ?></td>
            </tr>
</table>     
...
<!-------Table-------->   
        ...
        <col style="width:20%">
            ...
            <tr><td colspan="3"><p class="total">Total: <?php echo($total3); ?></p></td></tr>
            </table>    
